...
DIGEST = 'e73b6c8a47523beb1b6905ace1f114362107cda0604f4b295b7e40b91145b9db'
...
class InstallerTests(unittest.TestCase):
    def setUp(self):
        ...
        stub.write_text('#!/usr/bin/env python3\n' + textwrap.dedent('''\
            ...
            elif cmd=='defaults': print(os.environ.get('INSTALLED_VERSION','1.3.0'))
    ...
    def test_older_verified_installation_is_upgraded_in_place(self):
        ...
        self.assertIn('Updated FairyStack 1.0.1 to 1.3.0',result.stdout);self.assert_clean()
        calls=(self.root/'calls').read_text()
    ...
    def test_newer_installation_is_kept(self):
        sentinel=self.installed_old()
        result=self.run_installer(INSTALLED_VERSION='1.4.0')
    ...
    def test_legacy_companion_is_upgraded_into_fairystack_app(self):
        ...
        self.assertIn('Updated FairyStack 1.1.1 to 1.3.0',result.stdout);self.assert_clean()
        calls=(self.root/'calls').read_text()
        self.assertIn('FairyStack-1.3.0.zip',calls)
    ...
    def test_current_legacy_bundle_is_renamed_without_download(self):
        ...
        result=self.run_installer(INSTALLED_VERSION='1.3.0')
        self.assertEqual(result.returncode,0,result.stderr)
